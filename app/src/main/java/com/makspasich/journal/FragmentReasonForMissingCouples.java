...
public class FragmentReasonForMissingCouples extends Fragment {
    ...
    private RVAdapterForReasonForMissingCouples mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv_reason);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        mAdapter = new RVAdapterForReasonForMissingCouples(getActivity(), getAllItems());
